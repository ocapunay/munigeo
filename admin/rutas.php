...
<nav class="art-nav clearfix">
    <ul class="art-hmenu"><li><a href="mapa.php" class="">Mapa</a></li>
    <li><a href="rutas.php" class="active">Rutas</a></li></ul> 
    </nav>
<div class="art-layout-wrapper clearfix">
                ...
                <iframe src="../ruta.php" width="100%" height="600"></iframe>
                </div>
...
<div class="art-content-layout">
    ...
    <div class="art-layout-cell layout-item-0" style="width: 25%">
        ...
        <ul>
        <li style="text-align: left;">Oscar Capu&ntilde;ay Uceda</li>
        <li style="text-align: left;">Benjamín Capu&ntilde;ay Uceda</li>
        <li style="text-align: left;">Carlos Capu&ntilde;ay Uceda</li>
        </ul>
